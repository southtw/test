...
cursor.Data = game:HttpGet("https://raw.githubusercontent.com/southtw/test/refs/heads/main/helper/cursor.png")
...
menu.outline.outline.main.text.Text = "risen"
...
function library:saveConfig()
    ...
    writefile("risen/"..tostring(game.GameId).."/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
function library:loadConfig()
    ...
    if not isfile("risen/"..tostring(game.GameId).."/"..name..".cfg") then
        library:notify("Config file not found!")
        return
    end
    local config = game:GetService("HttpService"):JSONDecode(readfile("risen/"..tostring(game.GameId).."/"..name..".cfg"))
...
function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("risen/"..tostring(game.GameId)) do
...
function library:deleteConfig()
    if isfile("risen/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg") then
        delfile("risen/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg")
        library:refreshConfigs()
    end
end
